...
class AwesomeOscillatorIndicator{
     ...
     * @param c {Array<number>}  The Closing Candles
     * @param v {Array<number>}  The Volumes
     * @param args.fastPeriod the moving average fast period (default 5)
     * @param args.slowPeriod the moving average slow period (default 34)
     * @param candles
     * @returns [Number]
     * */
    static getData(o,h,l,c,v, args, candles){
...
class CciIndicator{
     ...
     * @param c {Array<number>}  The Closing Candles
     * @param v {Array<number>}  The Volumes
     * @param args.period (the moving average period default 20)
     * @param candles
     * @returns [Number]
     * */
    static getData(o,h,l,c,v, args, candles){
...
class ForceIndexIndiactor{
     ...
     * @param c {Array<number>}  The Closing Candles
     * @param v {Array<number>}  The Volumes
     * @param args.period (the moving average period default 1)
     ** @param candles
     * @returns [Number]
     * */
    static getData(o,h,l,c,v, args, candles){
...
class PsarIndicator{
     ...
     * @param c {Array<number>}  The Closing Candles
     * @param v {Array<number>}  The Volumes
     * @param args.step (step float default 0.02 )
     * @param args.max ( max float default 0.02 )
     * @param candles
     * @returns [Number]
     * */
    static getData(o,h,l,c,v, args, candles){
...
class RocIndicator{
     ...
     * @param c {Array<number>}  The Closing Candles
     * @param v {Array<number>}  The Volumes
     * @param args.period (The moving average period default 12)
     * @param candles
     * @returns [Number]
     * */
    static getData(o,h,l,c,v, args, candles){
...
class StochasticIndicator{
     ...
     * @param v {Array<number>}  The Volumes
     * @param args.period (the moving average period default 14)
     * @param args.signalPeriod (the signal period default 3)
     * @param candles
     * @returns [{k:Number}]
     * */
...
class TrixIndicator{
     ...
     * @param c {Array<number>}  The Closing Candles
     * @param v {Array<number>}  The Volumes
     * @param args.period (the moving average period default 18)
     * @param candles
     * @returns [Number]
     * */
    static getData( o,h,l,c,v,args, candles){
...
class VolumeProfile{
     ...
     * @param c {Array<number>}  The Closing Candles
     * @param v {Array<number>}  The Volumes
     * @param args.period (The Number of Bars to index)
     * @param candles
     * @returns {Array<vp>}
     * */
    static getData(o,h,l,c,v, args, candles){
...
class IchimokuCloudIndicator{
     ...
     * @param c {Array<number>}  The Closing Candles
     * @param v {Array<number>}  The Volumes
     * @param args.conversionPeriod (conversionPeriod default 9)
     * @param args.basePeriod (basePeriod default 26)
     * @param args.spanPeriod (spanPeriod default 52)
     * @param args.displacement (displacement default 26)
     * @param candles
...
class IndicatorUtils{
     ...
     * @param args.period (Number range for max values )
     * @return {number[]}
     * @constructor
     */
     ...
     *
     * @param values (Number array)
     * @param args.period (Number range for min values )
     * @return {number[]}
     * @constructor
     */
